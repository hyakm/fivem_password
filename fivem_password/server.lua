...
--- CONFIG ---
password = "VotreMDP" -- Set server password here
kickMessage = "Mauvais mot de passe , viens ici pour avoir le mot de passe : LienDeVotreDiscord" -- The invalid password kick message. Default: Invalid Password
timeRanOutMsg = "Mot de passe : LienDeVotreDiscord" --Not active yet! Dont worry about this
timeoutMessage = "Mot de passe : hLienDeVotreDiscord" -- Displayed if the user tries to attempt too many times, this locks them out of the server for x seconds
